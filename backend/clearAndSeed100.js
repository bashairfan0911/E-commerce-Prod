...
async function clearAndSeed() {
    try {
        ...
        console.log('\n🛍️  Generating 100 new products with 4K images...');
        const products = generateProducts(100);

        console.log('📦 Adding products to database...');
        const addedProducts = await productModel.insertMany(products);
        console.log(`✅ Successfully added ${addedProducts.length} products with high-quality images!`);

        console.log('\n📊 Summary:');
        console.log(`- Total products: ${addedProducts.length}`);
        console.log(`- Image quality: 1920x1920 (4K ready)`);
